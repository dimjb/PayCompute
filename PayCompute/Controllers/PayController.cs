...
namespace PayCompute.Controllers
{
    public class PayController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            ViewBag.taxYears = await _payComputationService.GetAllTaxYear();
        ...
        public async Task<IActionResult> Create(PaymentRecordCreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                var payRecord = new PaymentRecord()
                {
                    ...
                    FullName = _employeeService.GetById(model.EmployeeId).Result.FullName,
                    NiNo = _employeeService.GetById(model.EmployeeId).Result.NationalInsuranceNo,
                    ...
                    UnionFee = unionFee = _employeeService.UnionFees(model.EmployeeId).Result,
                    SLC = studentLoan = _employeeService.StudentLoanRepaymentAmount(model.EmployeeId, totalEarnings).Result,
                    NIC = nationalInsurance = _nicService.NIContribution(totalEarnings),
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var model = new PaymentRecordDetailViewModel()
            {
                ...
                Year = _payComputationService.GetTaxYearById(paymentRecord.TaxYearId).Result.YearOfTax,
